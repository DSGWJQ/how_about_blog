...
packages:
  ...
  hexo-generator-searchdb@1.5.0:
    resolution: {integrity: sha512-d0b5SueDxJimTFaHpPg430FQFx7DtMkmEIHo0UTOjXWRy+eDqNSp1CuS04P7fWzMnH2h+aQc6O9D2yY+3sdAUg==}
  ...
  hexo-theme-butterfly@5.5.2:
    resolution: {integrity: sha512-4ZHHVqBnBSRAdE9dG6HwWqLo9RWKRPFDhZmTicjs8e8kXd/4XLXT4y6Mbv+9HxonjkC9TM/10Jxx2wtFcgrbKw==}
...
snapshots:
  ...
  hexo-generator-searchdb@1.5.0(chokidar@3.6.0):
    dependencies:
      nunjucks: 3.2.4(chokidar@3.6.0)
    transitivePeerDependencies:
      - chokidar
